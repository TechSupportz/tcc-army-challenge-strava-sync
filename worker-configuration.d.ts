/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7d49245c593f8788305283f1b2fafec2)
...
declare namespace Cloudflare {
	...
	interface Env {
		TCC_ARMY_CHALLENGE_STRAVA_SYNC: KVNamespace;
		STRAVA_BASE_URL: "https://www.strava.com/api/v3";
		STRAVA_CLIENT_ID: string;
		STRAVA_CLIENT_SECRET: string;
		STRAVA_TCC_CLUB_ID: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STRAVA_BASE_URL" | "STRAVA_CLIENT_ID" | "STRAVA_CLIENT_SECRET" | "STRAVA_TCC_CLUB_ID" | "GOOGLE_PRIVATE_KEY" | "GOOGLE_SERVICE_ACCOUNT_EMAIL" | "GOOGLE_SHEETS_ID">> {}
}
